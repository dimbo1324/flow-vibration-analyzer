"""Architecture boundary test: core/physics must not import from forbidden layers."""
...
_PHYSICS_PKG = Path(__file__).resolve().parents[4] / "iva" / "core" / "physics"
