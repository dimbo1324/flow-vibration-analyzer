"""Architecture boundary test: core/validation must not import from forbidden layers."""
...
_VALIDATION_PKG = Path(__file__).resolve().parents[4] / "iva" / "core" / "validation"
